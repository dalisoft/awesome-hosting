...
You can support project by **Clicking to name of service**, with 💲 badge, not **Pricing** or **Plans** link as **service
name links** includes affiliates (only those which with 💲 badge)
...
| [CockroachDB](https://www.cockroachlabs.com)                     | PostgreSQL         | [Pay-as-you-Go ](https://www.cockroachlabs.com/pricing/)                                         | [30 Day](https://www.cockroachlabs.com/docs/cockroachcloud/frequently-asked-questions#how-do-cockroachdb-dedicated-free-trials-work) | 10GB Storage / 50M requests/m |             |
